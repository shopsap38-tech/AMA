...
fputcsv($out, ['Réparations sur la période', $d['reparations_total']], ';');
fputcsv($out, ['Palettes réparées', $d['reparations_reparee']], ';');
fputcsv($out, ['Palettes irréparables', $d['reparations_irrep']], ';');
